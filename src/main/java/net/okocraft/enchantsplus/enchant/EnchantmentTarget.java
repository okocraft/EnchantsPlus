...
/**
 * Represents the applicable target for Enchantments
 */
public enum EnchantmentTarget {

    /**
     * Allows the Enchantment to be placed on any other target
     */
    ALL {
        @Override
    ...
    /**
     * Allows the Enchantment to be placed on tools (spades, pickaxe, axes, hoe)
     */
    TOOL {
        @Override
        public boolean includes(@NotNull Material item) {
    ...
    /**
     * Allows the Enchantment to be placed on tools spades
     */
    SHOVEL {
        @Override
        public boolean includes(@NotNull Material item) {
    ...
    /**
     * Allows the Enchantment to be placed on tools pickaxe
     */
    PICKAXE {
        @Override
        public boolean includes(@NotNull Material item) {
    ...
    /**
     * Allows the Enchantment to be placed on tools hoe
     */
    HOE {
        @Override
        public boolean includes(@NotNull Material item) {
    ...
    public org.bukkit.enchantments.EnchantmentTarget toBukkit() {
        ...
        return org.bukkit.enchantments.EnchantmentTarget.valueOf(result.name());
    }
}
